  ...
  },
  {
    ...
    icon: (active) => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <path d="M12 3 4 7v6c0 4.2 3.4 7.4 8 8 4.6-.6 8-3.8 8-8V7l-8-4Z" />
    ...
    >
      <div className="relative mx-auto max-w-md">
        ...
        <button
          ...
          className="absolute  left-1/2 -top-6 z-50 flex h-14 w-14 -translate-x-1/2 cursor-pointer items-center justify-center rounded-full bg-orange-500 text-white shadow-xl transition hover:scale-105 hover:bg-orange-600 ring- ring-white  hover:brightness-110"
        >
          {isChatOpen ? (
        ...
        <div
          className="relative flex items-center justify-around rounded-t-3xl border-t-2 border-orange-500/60 bg-ink-950/95 px-2 pb-2.5 pt-4 shadow-[0_-4px_20px_rgba(0,0,0,0.35)] backdrop-blur"
          style={{
            WebkitMaskImage:
